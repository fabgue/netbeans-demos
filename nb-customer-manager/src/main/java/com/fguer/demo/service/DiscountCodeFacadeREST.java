...
import com.fguer.demo.entity.DiscountCode;
 ...
 */
@Stateless
@Path("com.fguer.demo.entity.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "com.fguer.demo_nb-customer-manager_war_1.0PU")
